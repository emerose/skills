...
| Mark up a CRO's **draft protocol / study plan** and return it with tracked changes | [references/cro-documents.md](references/cro-documents.md) → the mechanics live in the separate **[docx-markup](../docx-markup/SKILL.md)** skill |
